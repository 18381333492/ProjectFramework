...
public class PinYinHelper
{
    ...
    /// 转换
    /// </summary>
    /// <param name="hz">要转换的汉字</param>
    /// <param name="f">是否检索每个汉字输出首字母</param>
    /// <returns></returns>
    ...
    /// <summary>
    /// 将汉字转换成拼音 
    /// 如：PinYinHelper.GetPinYin("成都市",true)  返回：cds
    ///     PinYinHelper.GetPinYin("成都市",false)  返回：chengdushi
    /// </summary>
    /// <param name="hz">全拼音</param>
    /// <param name="f">是否返回每个汉字首字母</param>
    /// <returns></returns>

...
namespace Onlinepay
{
    public class SDKUtil
    {
        ...
        public static string CreateAutoSubmitForm(string url, Dictionary<string, string> data, Encoding encoder)
        {
            ...
            html.AppendFormat("<form id='pay_form'  target='_blank' action='{0}' method='post'>", url);
            foreach (KeyValuePair<string, string> kvp in data)
            {
        ...
        public static string CreateManualSubmitForm(string url, Dictionary<string, string> data, Encoding encoder)
        {
            StringBuilder html = new StringBuilder();
            ...
            html.Append("<input id='btnPay' value='submit' type='submit'/>");
            html.AppendLine("</form>");
            return html.ToString();
        } 

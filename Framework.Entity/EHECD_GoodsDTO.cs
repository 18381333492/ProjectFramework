...
{
    [Serializable]
    [TableInfo(TableName = "EHECD_Goods")]
    public class EHECD_GoodsDTO
    {
        ...
        /// 商品所属店铺
        /// </summary>
        [FieldInfo(DataFieldLength = 100,DataFieldPrecision = 0,DataFieldScale = 0,FiledName = "sStoreId",Required = true,DataLength = 50)]
        ...
        /// 活动商品的使用时间段
        /// </summary>
        [FieldInfo(DataFieldLength = 200, DataFieldPrecision = 0, DataFieldScale = 0, FiledName = "sActivityUseTime", Required = true, DataLength = 100)]
        public String sActivityUseTime
        {
            get; set;
        }
    }

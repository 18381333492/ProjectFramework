if (!modules.get("cache").getCache("laydate")) {

    modules.get("cache").setCache("laydate", new function () {
        var config = {
            path: '', //laydate所在路径
            skin: 'molv', //初始化皮肤
        ...
        Dates.getPath = (function () {            
            ...
            for (var i = 0; i < js.length; i++) {
                if (js[i].src.indexOf("laydate.js") >= 0 || js[i].src.indexOf("laydate.dev.js") >= 0) {
                    jsPath = js[i].src;
                    break;
                }
            }

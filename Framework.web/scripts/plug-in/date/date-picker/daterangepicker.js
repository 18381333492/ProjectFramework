...
* * @version: 1.3
* 
* @author: Dan Grossman http://www.dangrossman.i
* o/
* @date: 2014
* 4-29
* @copyright: Copyright (c) 2012-2014 Dan Grossman. All rights r
* erved.
* @license: Licensed under Apache License v2.0. See http://www.apache.org/licenses/L
* ENSE-2.0
* @website: http://www.im
* ovely.com/
*/
!function ($, moment) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        this.container.on('mouseleave', $.proxy(this.clickCancel, this));
...
}(window.jQuery, modules.get("cache").getCache("moment"));
